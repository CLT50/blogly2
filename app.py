...
@app.route('/')
def root():
    """Shows recent list of posts, most-recent first."""
...
@app.route('/users')
def users_index():
    """Page showing all users information"""
...
def users_new():
    ...
    new_user = User(
        ...
        image_url=request.form['image_url'] or default)
...
def posts_show(post_id):
    """Page showing specific post information"""
